...
const HeaderMain = () => {
  ...
  // console.log("🚀 ~ file: HeaderMain.js:6 ~ HeaderMain ~ user:", user);
  const favoriteCount =
    photos.length > 0
    ...
    <div className="p-4 bg-white shadow-md flex items-center justify-center">
      ...
      <div className="ml-auto mr-5 flex items-center gap-5">
        <span className="relative w-8">
          ...
          <span className="absolute right-0 top-0 translate-x-2/4 text-xs w-5 h-5 rounded-full flex items-center justify-center text-white bg-pink-600">
            {cartItemsCount || 0}
          </span>
        </span>
        <span className="relative w-8">
