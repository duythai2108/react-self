...
const PhotoList = () => {
  ...
  // console.log("🚀 ~ file: PhotoList.js:7 ~ PhotoList ~ cartItems:", cartItems);
  return (
...
const PhotoItem = ({ info: { url, isFavorite, id } }) => {
  // console.log(
  //   "🚀 ~ file: PhotoList.js:21 ~ PhotoItem ~ isFavorite:",
  //   isFavorite
  // );
  ...
  return (
    <div className="relative h-[300px] cursor-pointer group">
      ...
      <button
        className="p-4 bg-white rounded-lg text-black absolute bottom-5 left-2/4 -translate-x-2/4 py-3 px-6 text-sm font-semibold opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all"
