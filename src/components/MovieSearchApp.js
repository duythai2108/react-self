...
// https://api.themoviedb.org/3/movie/550?api_key=85656256c9159e67d6afdf3ce683dea5
// https://api.themoviedb.org/3/search/movie?api_key=85656256c9159e67d6afdf3ce683dea5&query=''
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      const response = await axios.get(
        ` https://api.themoviedb.org/3/search/movie?api_key=85656256c9159e67d6afdf3ce683dea5&query='${queryDebounce}'`
      );
  ...
  return (
    <div className="p-10">
      <div className="w-full max-w-[500px] mx-auto mb-20">
        <input
          type="text"
          className="w-full p-5 rounded-lg border border-purple-500 shadow-purple-400 shadow-lg"
    ...
    <div className="bg-white p-3 rounded-2xl shadow-sm flex flex-col">
      ...
      <div className="p-7 flex-1 flex-col">
        <h3 className="text-lg text-black font-semibold mb-4">
          <LoadingSkeleton height="20px" radius="16px"></LoadingSkeleton>
        </h3>
        <p className="text-[#999] text-sm !leading-loose mb-6">
